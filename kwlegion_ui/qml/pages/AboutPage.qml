...
Additionally, the Qt Graphs module is used here under the <a href="https://www.gnu.org/licenses/gpl-3.0.en.html#license-text">GNU Public License version 3 (GPLv3)</a>`)
            HoverHandler {
